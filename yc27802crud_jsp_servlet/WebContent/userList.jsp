...
<script type="text/javascript">
	...
	function del(id,name)
	{
		if(window.confirm("确认删除用户："+name))
			{
		location.href ="${pageContext.request.contextPath }/UserController?m=del&operator_id="+id;
			}
	}
</script>
</head>
<body>
	<div align="center">
		<p align="left">
			<a href="#"
				onclick="myOpen('${pageContext.request.contextPath }/userAdd.jsp')">增加用户</a>
		</p>
		...
		<table border="0" width="640">
			...
			<c:forEach items="${us}" var="u">
				<tr>
					...
					<td><a
						href="${pageContext.request.contextPath }/UserController?m=update&operator_id=${u.operator_id}">修改</a></td>
